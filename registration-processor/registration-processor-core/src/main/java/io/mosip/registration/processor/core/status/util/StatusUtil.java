...
public enum StatusUtil {
	...
	TEMPLATE_CONFIGURATION_NOT_FOUND(StatusConstants.MESSAGE_SENDER__FAILED_CODE + "002","Template configuration and language not found"),
	EMAIL_PHONE_TEMPLATE_NOTIFICATION_MISSING(StatusConstants.MESSAGE_SENDER__FAILED_CODE + "003","Email ID or Phone or Template or Notification Type is Missing"),
	NOTIFICATION_FAILED_FOR_LOST(StatusConstants.MESSAGE_SENDER__FAILED_CODE + "004","Unable to Send Notification - UIN was not found for the Lost Packet"),

	MESSAGE_SENDER_NOTIF_SUCC(StatusConstants.MESSAGE_SENDER_NOTIF_SUCCESS_CODE + "001","Email and SMS Notification were sent"),
	MESSAGE_SENDER_NOT_CONFIGURED(StatusConstants.MESSAGE_SENDER_NOTIF_SUCCESS_CODE + "002", "Notification was not sent as notification type was not set"),
    MESSAGE_SENDER_EMAIL_SUCCESS(StatusConstants.MESSAGE_SENDER_NOTIF_SUCCESS_CODE + "003","Email Notification was sent"),
